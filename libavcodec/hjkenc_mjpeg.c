...
static const AVOption options[] = {
    ...
    { "profile",      "Set the encoding profile",           OFFSET(profile),      AV_OPT_TYPE_INT,   { .i64 = HJK_ENC_MJPEG_PROFILE_MAIN }, HJK_ENC_MJPEG_PROFILE_BASELINE, HJK_ENC_MJPEG_PROFILE_HIGH_444P, VE, "profile" },
